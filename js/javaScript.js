...
function adicionaPessoa() {
    ...
    if(document.getElementById('nome').value == '') {
        ...
        // E adicionamos um novo aviso com sua classe para dizer que o campo está vazio
    ...
    // Caso tenhamos um nome
    } else {

        // Criamos um objeto pessoa com o nome obtido do input e uma conta zerada
        let pessoa = {
            nome: document.getElementById('nome').value,
            conta: 0,
        };
    
        // Colocamos o objeto no array de pessoas
        pessoas.push(pessoa);
        ...
        // E avisamos o usuário que o nome da pessoa foi inserido com sucesso
        $('#avisoPessoa').empty();
...
function adicionarItem() {
    ...
    if (document.getElementById('item').value == ''){
        ...
        if (document.getElementById('preco').value == '') {
            ...
            } else { // Se estiver tudo certo, continuamos
